...
requests, explicit unavailable status, persistent SNTP, and independent serial
export. Radio provisioning and Wi-Fi coexistence still require ESP-IDF builds
